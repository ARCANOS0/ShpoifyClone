...
<head>
  ...
  <link rel="stylesheet" href="../content/kitchen.css">
  ...
  <div class=" mt-3 px-5">
    ...
    <div class="row d-flex flex-wrap align-items-stretch">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/electrical/0.webp" alt="Cooking Pan 1" class="img-fluid mb-3">
        <div class="star">
        ...
        <h5 class="p-name">Kenwood HG230 Electric Health Grill</h5>
        <h4 class="p-price">$77.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/electrical/2.webp" alt="Cooking Pan 2" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Freach stand electric fan </h5>
        <h4 class="p-price">$99.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/electrical/3.webp" alt="Cooking Pan 3" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Braun Cj3000BK Electric Citrus press</h5>
        <h4 class="p-price">$90.199</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
    </div>
    ...
    <div class="row d-flex flex-wrap align-items-stretch mt-4">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/electrical/1.webp" alt="Cooking Pan 4" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Black&White H2500 Mixer With Bowl Multicolor</h5>
        <h4 class="p-price">$55.494</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/electrical/5.webp" alt="Cooking Pan 5" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        </div>
        <h5 class="p-name">Black&Decker 4liter Fryer- AF400-B5-220V</h5>
        <h4 class="p-price">$99.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/electrical/7.webp" alt="Cooking Pan 6" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">TASMAX mini waffle maker machine 3in1 waffle iron home appliances kitchen</h5>
        <h4 class="p-price">$200.9</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
    </div>
    ...
    <div class="row d-flex flex-wrap align-items-stretch mt-4">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/electrical/8.webp" alt="Cooking Pan 4" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Sokany 400W STRIP 2L SOCKANE SK-7020</h5>
        <h4 class="p-price">$100.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/electrical/6.webp" alt="Cooking Pan 5" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">H-Kitchen 1Tonic Electric Fryer-6L</h5>
        <h4 class="p-price">$234.481</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/electrical/8.jpg" alt="Cooking Pan 6" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Ariete Vintage oil radiator</h5>
        <h4 class="p-price">$188.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
    </div>
