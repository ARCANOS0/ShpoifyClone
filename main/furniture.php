  ...
  <div class=" mt-3 px-5">
    ...
    <div class="row d-flex flex-wrap align-items-stretch">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/furniture/fur2.jpg" alt="a chair" class="img-fluid mb-3">
        <div class="star">
        ...
        <h5 class="p-name"> Wooden book saver</h5>
        <h4 class="p-price">$92.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/furniture/fur1.jpg" alt="a unit" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Rattan Swing Iron Chassis Single  </h5>
        <h4 class="p-price">$199.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/furniture/fur3.jpg" alt="double bed" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">white side storage</h5>
        <h4 class="p-price">$110.5</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
    </div>
    ...
    <div class="row d-flex flex-wrap align-items-stretch mt-4">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/furniture/fur4.jpg" alt="sofa" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">A comfortable sofa</h5>
        <h4 class="p-price">$240</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/furniture/fur5.jpg" alt="royal tables" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        </div>
        <h5 class="p-name">A TV stand table </h5>
        <h4 class="p-price">$150.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/furniture/fur6.jpg" alt="A TV table" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Arabic styled Floor sit </h5>
    ...
    <div class="row d-flex flex-wrap align-items-stretch mt-4">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/furniture/fur7.jpg" alt="table with chairs" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">white dining chair set</h5>
        <h4 class="p-price">$289.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/furniture/fur8.jpg" alt="A side sofa" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">A side couch</h5>
        <h4 class="p-price">$99.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/furniture/fur9.jpg" alt="bed" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">black main couch</h5>
        <h4 class="p-price">$149.96</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
    </div>
