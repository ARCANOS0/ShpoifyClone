    ...
    <section class="container details my-5 pt-5">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100" src="../pic/kitchen/cup1.png" alt="">
            </div>
            
            <div class="col-lg-6 col-md-12 col-12">
                <h6>kitchen/Cups</h6>
                <h3 class="py-2">Glass Cup Set</h3>
                <h2>22.99$</h2>
                <input type="number" value="1">
                <button>Add To Cart</button>
                <h4 class="mt-5">Product Details</h4>
                <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente aliquam esse consectetur, corporis doloribus illum cum necessitatibus eos soluta recusandae assumenda velit dolor omnis dolore expedita optio similique aspernatur dicta.</span>
            </div>
        </div>
    </section>
