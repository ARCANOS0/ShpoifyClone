  ...
  <div class=" mt-3 px-5">
    ...
    <div class="row d-flex flex-wrap align-items-stretch">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/watch/watch1.jpg" alt="Cooking Pan 1" class="img-fluid mb-3">
        <div class="star">
        ...
        <h5 class="p-name">Pluse X Smart</h5>
        <h4 class="p-price">$92.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/watch/watch8.jpg" alt="Cooking Pan 2" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Vintage Royal</h5>
        <h4 class="p-price">$195.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/watch/watch2.jpg" alt="Cooking Pan 3" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Elegance Brown</h5>
        <h4 class="p-price">$92.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
    </div>
    ...
    <div class="row d-flex flex-wrap align-items-stretch mt-4">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/watch/watch9.jpg" alt="Cooking Pan 4" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Active Pro S9</h5>
        <h4 class="p-price">$12.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/watch/watch3.jpg" alt="Cooking Pan 5" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        </div>
        <h5 class="p-name">RoseGold Chic</h5>
        <h4 class="p-price">$9.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/watch/watch4.jpg" alt="Cooking Pan 6" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
    ...
    <div class="row d-flex flex-wrap align-items-stretch mt-4">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/watch/watch5.jpg" alt="Cooking Pan 4" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Tactical Force</h5>
        <h4 class="p-price">$100.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/watch/watch6.jpg" alt="Cooking Pan 5" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Silver Classic</h5>
        <h4 class="p-price">$47.23</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/watch/watch7.jpg" alt="Cooking Pan 6" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">DeepWave Black</h5>
