  ...
  <div class="container">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Tarek Ayman</p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Gasser Mohammed</p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Mohammad Rabie</p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Osama Al-Sayed </p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Mohamed Shaaban</p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Mahmoud Arafa </p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Mohamed AbdelHamid</p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Hajar Taha</p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Shahd Mohamed</p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Basant Magdy</p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Thoraya Atef </p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Nada Mohammed </p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Aya Mokhtar </p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Mariam Madhat</p>
        </div>
      </div>
      <div class="col text-center">
        <div class="p-3 bg-white shadow rounded team-member"><i class="fa-solid fa-user fa-2x" style="color: #FF9149;"></i>
          <p class="mt-2 fw-bold">Toqa Essam </p>
        </div>
      </div>
