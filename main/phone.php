  ...
  <div class=" mt-3 px-5">
    ...
    <div class="row d-flex flex-wrap align-items-stretch">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/6.webp" alt="Cooking Pan 1" class="img-fluid mb-3">
        <div class="star">
        ...
        <h5 class="p-name">Redmi Note 14</h5>
        <h4 class="p-price">$153.77</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/8.webp" alt="Cooking Pan 2" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Infinix</h5>
        <h4 class="p-price">$177.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/7.jpg" alt="Cooking Pan 3" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
    ...
    <div class="row d-flex flex-wrap align-items-stretch mt-4">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/13.webp" alt="Cooking Pan 4" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Infinix</h5>
        <h4 class="p-price">$255.88</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/15.webp" alt="Cooking Pan 5" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h4 class="p-price">$198.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/16.webp" alt="Cooking Pan 6" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Samsung A06</h5>
        <h4 class="p-price">$96.66</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
    </div>
    ...
    <div class="row d-flex flex-wrap align-items-stretch mt-4">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/19.webp" alt="Cooking Pan 4" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Samsung M55</h5>
        <h4 class="p-price">$270.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/21.webp" alt="Cooking Pan 5" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Redmi</h5>
        <h4 class="p-price">$147.23</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/24.webp" alt="Cooking Pan 6" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
...
<div class="row d-flex flex-wrap align-items-stretch mt-4">
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/28.jpg" alt="Cooking Pan 4" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Realme 14C</h5>
        <h4 class="p-price">$270.99</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/29.jpg" alt="Cooking Pan 5" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Samsung s24</h5>
        <h4 class="p-price">$547.23</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
      <div class="product text-center col-lg-4 col-md-4 col-12">
        <img src="../pic/phone/30.jpg" alt="Cooking Pan 6" class="img-fluid mb-3">
        <div class="star">
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
          <i class="fa-solid fa-star"></i>
        ...
        <h5 class="p-name">Samsung A26</h5>
        <h4 class="p-price">$181.96</h4>
        <button class="btn btn-primary buy-btn">Buy Now</button>
      </div>
    </div>
